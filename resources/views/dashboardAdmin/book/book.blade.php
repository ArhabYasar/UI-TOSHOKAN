...
<body>
    ...
    <main>
        <div class="search-container">
            ...
            <a href="/dashboardAdmin/book/add" class="tombol">Add Data</a>
        </div>
        <table>
            <thead>
                <tr>
                    <th class="col-no">No</th>
                    <th class="col-no">Judul</th>
                    <th class="col-no">Kategori</th>
                    <th class="col-no">Status</th>
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>Haikyuu!!! Road To The Top!</td>
                    <td>Manga</td>
                    <td>On-Stock</td>
                    <td>
                        <a href="/dashboardAdmin/book/update">
