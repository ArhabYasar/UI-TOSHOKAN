    ...
    <main>
        ...
        <div class="input-detail">
            ...
            <div class="input-row">
                ...
                <input type="number" id="phone" name="phone" required autocomplete="off" value="089656051140">
            </div>

            <div class="input-row">
                <label for="address">Address:</label>
                <textarea id="address" name="address" required autocomplete="off" class="textarea">Kp. Cijeungjing</textarea>
            </div>

            <div class="input-row">
                <label for="status">Status:</label>
                <input type="text" id="status" name="status" required autocomplete="off" value="Active">
            </div>
