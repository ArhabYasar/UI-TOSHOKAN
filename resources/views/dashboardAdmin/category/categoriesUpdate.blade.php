...
<body>
    <nav>
        ...
        <div class="sidebar-links">
            <ul>
                ...
                <li>
                    <a href="/dashboardAdmin/category" class="active" data-active="2">
                        <div class="icon">
    ...
    <main>
        <div class="search-container">
            <p>Categories Update</p>
            <a href="/dashboardAdmin/category" class="tombol">Back</a>
        </div>
        <div class="input-detail">
            <div class="input-row">
                <label for="gendre">Kategori:</label>
                <input type="text" id="gendre" name="gendre" required autocomplete="off" value="Manga">
            </div>
            <a href="/dashboardAdmin/category" class="tombol">
                Submit
            </a>
        </div>
        <p class="copyright">
