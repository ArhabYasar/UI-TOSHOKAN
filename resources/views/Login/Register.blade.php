        ...
        <div class="container">
            <ul>
                <li>
                    <a href="" class="logo">
                        <div class="images">
                            <img src="{{ asset(('img/toshokan_logo_dark.png')) }}" title="TOSHOKAN" class="logo-forlight">
                        </div>
                        <h2>TOSHOKAN</h2>
                    </a>
                </li>
                ...
                <div class="left">
                    <div class="form-wrapper">
                        ...
                        <div class="login-form">
                            ...
                            <div class="input-wrap">
                                <input type="number" class="login-input" autocomplete="off" required name="nis" id="nis">
                                <label for="nis">NIS</label>
                                <i class="icon fa-solid fa-id-card"></i>
                            </div>
                            <div class="input-wrap">
                                <input type="text" class="login-input" autocomplete="off" required name="phone" id="phone">
                                <label for="phone">Phone</label>
                                <i class="icon fa-solid fa-phone"></i>
                            </div>
                            <div class="input-wrap w-100">
                                <input type="text" class="login-input" autocomplete="off" required name="nama" id="nama">
                                <label for="nama">Nama</label>
                                <i class="icon fa-solid fa-id-badge"></i>
                            </div>
                            <div class="input-wrap w-100">
                                <input type="email" class="login-input" autocomplete="off" required name="email" id="email">
                                <label for="email">Email</label>
                                <i class="icon fa-solid fa-envelope"></i>
                            </div>
                            <div class="input-wrap w-100">
                                <input type="text" class="login-input" autocomplete="off" required name="jenis_kelamin" id="jenis_kelamin">
